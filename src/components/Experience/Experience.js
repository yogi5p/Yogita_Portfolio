          ...
          <div className="flex flex-column flex-row-ns">
            ...
            <div className="w-100 w-60-ns pl3-ns">
              ...
              <p className="f6 f5-l lh-copy">
                ...
                relationships and custom views. 
              </p>
            </div>
          </div>
        </article>
          ...
          <div className="flex flex-column flex-row-ns">
            <div className="w-100 w-60-ns pr3-ns order-2 order-1-ns">
              ...
              <p className="f6 f5-l lh-copy">
                ...
                viewer in a quick responsive way! Haute Dawg is a fictional bussiness
                that hopefully will be real some day that allows dog lovers and owners to connect people 
                ...
                exactly needed by the end user. I worked as a dedicated front end engineer on this project and oversaw the development of the
                UI as well as served as the Git master for our team, and you can view our code{' '}
                <a href="https://github.com/yogi5p/Final_CCGraduation_Project">here</a>. 
                I have a lot of room to improve and grow and I look forward to working on challenging and interesting projects.
              </p>
            </div>
